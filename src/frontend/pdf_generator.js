...
export function generate_final() {
    ...
    // doc.addImage(qr_code_top_left, 'PNG', 20, 127.5, 85, 85);
    // doc.addImage(qr_code_top_right, 'PNG', 97.5, 127.5, 85, 85);
    // doc.addImage(qr_code_bottom_left, 'PNG', 22.5, 202.5, 85, 85);
    // doc.addImage(qr_code_bottom_right, 'PNG', 97.5, 202.5, 85, 85);
