...
export function generate_qualification() {
    ...
    doc.rect(15,120,150,150, "F");
    doc.addImage(true_qr_code, 'PNG', 17, 122, 65.5, 65.5);
    doc.addImage(true_qr_code, 'PNG', 92, 122, 65.5, 65.5);
    doc.addImage(true_qr_code, 'PNG', 17, 197, 65.5, 65.5);
    doc.addImage(true_qr_code, 'PNG', 92, 197, 65.5, 65.5);
...
export function generate_final() {
    ...
    doc.addImage(qr_code_top_left, 'PNG', 17, 122, 65.5, 65.5);
    doc.addImage(qr_code_top_right, 'PNG', 92, 122, 65.5, 65.5);
    doc.addImage(qr_code_bottom_left, 'PNG', 17, 197, 65.5, 65.5);
    doc.addImage(qr_code_bottom_right, 'PNG', 92, 197, 65.5, 65.5);
